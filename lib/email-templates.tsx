  ...
  <div style={{ fontFamily: "sans-serif", maxWidth: "600px", margin: "0 auto" }}>
    ...
    <div style={{ padding: "32px", backgroundColor: "#f9fafb" }}>
      ...
      <p style={{ fontSize: "16px", lineHeight: "1.6" }}>
        Thank you for creating your GuideBuoy AI account! We're here to help you navigate your financial dispute with
        confidence.
      </p>
      {hasRouterSession && (
        <div
    ...
    <div style={{ padding: "16px", textAlign: "center", fontSize: "12px", color: "#9ca3af" }}>
      <p>© 2025 GuideBuoy AI. All rights reserved.</p>
    </div>
  </div>
)
...
export const WaitlistConfirmationEmail: React.FC<WaitlistConfirmationProps> = ({ userName, userEmail, source }) => (
  <div style={{ fontFamily: "sans-serif", maxWidth: "600px", margin: "0 auto" }}>
    ...
    <div style={{ padding: "32px", backgroundColor: "#f9fafb" }}>
      <p style={{ fontSize: "16px", lineHeight: "1.6" }}>Hi {userName || "there"},</p>
      <p style={{ fontSize: "16px", lineHeight: "1.6" }}>
        Thank you for joining the GuideBuoy AI waitlist! We're working hard to launch our full case management platform.
      </p>
      <div
        style={{
          backgroundColor: "#dbeafe",
      ...
      <p style={{ fontSize: "14px", color: "#6b7280", marginTop: "32px" }}>Questions? Reply to this email anytime.</p>
    </div>
    <div style={{ padding: "16px", textAlign: "center", fontSize: "12px", color: "#9ca3af" }}>
      <p>© 2025 GuideBuoy AI. All rights reserved.</p>
    </div>
  ...
  return (
    <div style={{ fontFamily: "sans-serif", maxWidth: "600px", margin: "0 auto" }}>
      ...
      <div style={{ padding: "32px", backgroundColor: "#f9fafb" }}>
        ...
        <p style={{ fontSize: "16px", lineHeight: "1.6" }}>
          GuideBuoy AI helps you manage financial disputes with FIDReC. By accepting this invitation, you'll be able to
          collaborate on case documents, evidence, and submissions.
        </p>
        <div style={{ textAlign: "center", marginTop: "32px" }}>
          <a
            href={inviteUrl}
        ...
        <p style={{ fontSize: "14px", color: "#6b7280", marginTop: "16px" }}>
          If you don't have a GuideBuoy AI account yet, you'll be prompted to create one when you accept the invitation.
        </p>
      </div>
      <div style={{ padding: "16px", textAlign: "center", fontSize: "12px", color: "#9ca3af" }}>
        <p>© 2025 GuideBuoy AI. All rights reserved.</p>
        <p style={{ marginTop: "8px" }}>If you didn't expect this invitation, you can safely ignore this email.</p>
      </div>
    </div>
  )
}
